...
F 1 "IS25LP256x-xM" H 2900 1400 50  0000 C CNN
F 2 "Package_SO:SOIC-16W_7.5x10.3mm_P1.27mm" H 2550 2450 50  0001 C CNN
...
QSPI0_CLK
Text Label 1000 1850 0    39   ~ 0
QSPI0_NCS_F
Text Label 1000 1950 0    39   ~ 0
QSPI0_IO2
...
U 1 1 5E2A7BA9
P 2500 2450
F 0 "#PWR058" H 2500 2200 50  0001 C CNN
...
U 1 1 5E2AB2D6
P 2500 900
F 0 "#PWR057" H 2650 850 50  0001 C CNN
F 1 "V3P3" H 2505 1075 50  0000 C CNN
...
U 1 1 5E2ABAA3
P 3050 1100
F 0 "C48" H 3142 1146 50  0000 L CNN
...
U 1 1 5E2ACA86
P 3050 1300
F 0 "#PWR061" H 3050 1050 50  0001 C CNN
...
U 1 1 5E2B4C89
P 1900 1250
F 0 "R32" H 1900 1400 50  0000 L CNN
F 1 "10K" H 1900 1100 50  0000 L CNN
...
Wire Wire Line
	1650 900  1650 950 
$Comp
L aardonyx:V3P3 #PWR054
U 1 1 5E2E3983
P 1650 900
F 0 "#PWR054" H 1800 850 50  0001 C CNN
F 1 "V3P3" H 1655 1075 50  0000 C CNN
...
U 1 1 5E2C54E1
P 1400 1250
F 0 "R30" H 1400 1400 50  0000 L CNN
F 1 "10K" H 1400 1100 50  0000 L CNN
F 2 "" V 1440 1240 50  0001 C CNN
...
U 1 1 5E2C33CD
P 1650 1250
F 0 "R31" H 1650 1400 50  0000 L CNN
F 1 "10K" H 1650 1100 50  0000 L CNN
F 2 "" V 1690 1240 50  0001 C CNN
...
U 1 1 5F693FFB
P 4500 4900
F 0 "#PWR065" H 4650 4850 50  0001 C CNN
...
QSPI0_IO0
Text HLabel 1000 2050 0    50   BiDi ~ 0
QSPI0_IO3
...
Wire Wire Line
	1000 2050 1400 2050
Text HLabel 3400 1650 2    50   BiDi ~ 0
QSPI0_IO1
Wire Wire Line
	2950 3100 3350 3100
Wire Wire Line
