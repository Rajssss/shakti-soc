...
if { [get_ips -quiet mig_7series_0] eq "" } {
    create_ip -name mig_7series -vendor xilinx.com -library ip -module_name mig_ddr2
} else {
    reset_run mig_synth_1
}

set_property CONFIG.XML_INPUT_FILE [file normalize $home_dir/tcl/nexy4ddr_mig.prj] [get_ips mig_ddr2]
generate_target {instantiation_template} [get_ips mig_ddr2]
create_ip_run [get_ips mig_ddr2]
